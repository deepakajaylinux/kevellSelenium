...
* Type URL: http://seleniumhq.org/download/ in your browser. Selenium IDE download page will get open then click on latest Download version link as shown in image below. Click on that link.
...
* When you click on allow button, Firefox will automatically install Selenium IDE software. After completion of Selenium IDE installation, it will show one pop up
* When you click on Restart Now button, Firefox will restart automatically. Now click on Tools menu list displayed in top. You can see there selenium IDE as shown in image below.
